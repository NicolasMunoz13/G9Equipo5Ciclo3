...
<script>
	var baseurl = "http://localhost:8080/reportes";
...
<div class="full-form">
  ...
  <form class="row g-3" id="flex-parent-element" type="" method="">
    ...
    <!--  Aqui es donde se autogenera la tabla basado en el script -->
					<div class="col align-self-center" id="reportesinfo">
...
<div class="center">
     <div id="flex-child-element">
      ...
      <button type="button" class="btn btn-warning btn-lg" onclick= "window.location.href='/listaclientesreportes.jsp'">Ventas por Cliente</button>
    </div>
