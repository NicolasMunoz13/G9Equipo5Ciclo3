...
<div class="full-form">
  ...
  <form class="row g-3" id="flex-parent-element" type="" method="">
    ...
    <div class="col-12" >
      <div class="form-floating">
        <input type="text" class="form-control" id="direccion_proveedor" id="form-floating " placeholder="Dirección de proveedor" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" name="Dirección de Cliente" required>
